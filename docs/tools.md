...
Before spawning, `claude_launch` runs [5 mandatory safety checks](safety.md). If any check fails, the launch is blocked with an actionable error message. Other tools and the gateway RPC skip these guards.
